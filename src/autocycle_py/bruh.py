...
def create_environment(req):
    ...
    # Creates objects
    req = sorted(req, key=lambda o: (o.z1 + o.z2) / 2)
    for o in req:
...
time0 = time.time()
create_environment([
    obj(-8500.0, -8400.0, 11671.0, 11587.0),
    obj(-7600.0, -6700.0, 8722.0, 9414.0),
    obj(-6650.0, -6400.0, 9511.0, 9643.0),
    obj(-6350.0, -6200.0, 9756.0, 9658.0),
    obj(-6150.0, -6000.0, 9878.0, 9697.0),
    obj(-5800.0, -5300.0, 10184.0, 10343.0),
    obj(-5000.0, -4700.0, 10835.0, 11028.0),
    obj(-4650.0, -4450.0, 11110.0, 11221.0),
    obj(-3450.0, -3300.0, 12105.0, 12177.0),
    obj(-2850.0, -2750.0, 12570.0, 12705.0),
    obj(-2500.0, -2350.0, 14018.0, 14002.0),
    obj(-2000.0, -1900.0, 13267.0, 13385.0),
    obj(-1700.0, -1550.0, 14472.0, 14553.0),
    obj(-1500.0, -1400.0, 14531.0, 14604.0),
    obj(-650.0, -450.0, 4166.0, 4068.0),
    obj(-400.0, -150.0, 4078.0, 4090.0),
    obj(-100.0, 50.0, 13635.0, 13559.0),
    obj(100.0, 250.0, 13441.0, 13607.0),
    obj(400.0, 600.0, 13531.0, 13640.0),
    obj(1450.0, 2250.0, 5694.0, 5490.0),
    obj(2500.0, 2750.0, 20448.0, 20219.0),
    obj(4350.0, 4650.0, 17341.0, 17568.0),
    obj(6450.0, 6550.0, 15167.0, 15079.0),
    obj(6700.0, 6850.0, 15006.0, 15154.0),
    obj(7450.0, 7550.0, 16133.0, 16257.0),
    obj(7700.0, 7850.0, 16768.0, 16895.0),
    obj(7900.0, 8150.0, 14533.0, 14329.0),
    obj(9700.0, 9850.0, 13388.0, 13408.0)
])
print(((3.5**2) + (2.4**2))**(1/2))
print(((5.5**2) + (2.1**2))**(1/2))
# print(x_vals)
# print(y_vals)
